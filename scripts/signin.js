...
try {
  ...
  const actionCodeSettings = {
    url: 'https://nbi-green-economy.firebaseapp.com/SignIn.html', // Ensure this matches your authorized domain
  ...
  try {
    ...
    setTimeout(() => errorMessage.classList.add('hidden'), 5000);
          ...
          try {
            ...
            hideLoader();
            window.location.href = `../Dashboard/dashboard.html?userId=${user.uid}`;
          } catch (error) {
            hideLoader();
